import {
  ...
  StarsSection,
  ChatSection,
} from '@components/templates/StyledTemplateAndPages';
...
const ProfilePage = ({ profileData }: Props) => {
  ...
  let isMyProfile =
    profile?.first_section.avatar_and_profile_info.id === loggedUser.id;
  ...
  if (profile) {
    return (
      <>
        ...
        <DescriptionBox>
          <Typography>
            {profile?.first_section.avatar_and_profile_info.long_description}
          </Typography>
        </DescriptionBox>
